...
Public Class DesktopEdit
    ...
    Private Sub updatesave()
        ...
        Try
            ...
            cmd.CommandText = "update uiandux_page set describes=@describes,try=@try, buy=@buy,Name=@Name,Price=@price,categories=@categories where iD=@iD"
