...
Public Class AdminWebFlow
    ...
    Sub loadinflot()
        ...
        cmd = New MySqlCommand("Select Pics, Name, describes, buy, iD from web where Name like '%" & SearchTXT.Text & "%'", con)
        con.Open()
    ...
    Public Sub deletebtn_click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If MsgBox("Are you sure want to delete?", vbYesNo) = vbYes Then
            ...
            Try
                ...
                cmd.CommandText = "delete from web where iD=@iD"
