...
Public Class MobileFlow
    ...
    Private Sub getimage()
        Dim command As New MySqlCommand("SELECT  `buy`,`describes`,`Name`,`Pics`,`try`,`iD` FROM `mobile` WHERE `iD` = @iD", connection)
    ...
    Private Sub Button3_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            cmd.CommandText = "delete from mobile where Name=@firstname"
    ...
    Sub loadinflot()
        ...
        cmd = New MySqlCommand("Select Pics, Name, describes, buy, try, iD from mobile where Name like '%" & TextBoxX1.Text & "%'", cn)
        cn.Open()
        ...
        While dr.Read
            ...
            lbldescribes.Location = New Point(10, 50)
            lbldescribes.Text = dr.Item("describes").ToString
            lbldescribes.Size = New Point(260, 65)
            ...
            Launchbtn.Location = New Point(195, 115)
            Launchbtn.Size = New System.Drawing.Size(90, 30)
            Launchbtn.Text = "Send Link"
            ...
            Launchbtn.Tag = dr.Item("iD").ToString
    ...
    Public Sub Launchbtn_click(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            FlowMobileFreeinterface.Data_ID.Text = (sender.tag.ToString)

            Status.AddStatus("Mobile - Launch - " + sender.tag.ToString)


            FlowMobileFreeinterface.ShowDialog()
        Catch ex As Exception
    ...
    Sub loadrecord()
        ...
        cn.Open()
        cm = New MySqlCommand("select * from mobile where Name like '%" & TextBoxX1.Text & "%'", cn)
        dr = cm.ExecuteReader
        While dr.Read
    ...
    Private Sub updatesave()
        Try
            ...
            cmd = con.CreateCommand()
            cmd.CommandText = "update mobile set describes=@describes,try=@try, buy=@buy,Name=@firstname2,Price=@price where iD=@iD"
